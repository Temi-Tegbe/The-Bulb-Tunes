...
namespace TheBulbTunes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            userService.Create("Temiloluwa", "Tegbe", "temiloluwa.tegbe@thebulb.africa");
            ...
            userService.Create("Nkechi", "Okeke", "nkechu.okeke@thebulb.africa");
            ...
            Guid idOfSongToUpdate1 = new Guid("08d962f1b71"); //Nom-ecisting id
